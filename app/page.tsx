            ...
            <div className="grid lg:grid-cols-2 gap-10 items-center">
              ...
              >
                <div className="relative mx-auto w-full max-w-[480px] aspect-square">
                  {/* Multi-layer brand glow */}
                  <div className="absolute inset-0 bg-linear-to-br from-primary/25 via-secondary/30 to-gold/25 rounded-full blur-3xl opacity-70 animate-pulse [animation-duration:5s]" />
                  <div className="absolute inset-8 bg-linear-to-tl from-secondary/30 to-gold/15 rounded-full blur-2xl opacity-60" />

                  {/* GIANT cycle ring — the visual anchor */}
                  <div className="absolute inset-[12%] flex items-center justify-center">
                    <div className="relative w-full h-full">
                      ...
                      <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-12">
                        ...
                        <p className="font-heading text-5xl text-primary mt-2 tracking-tight">
                          {t("Luteal", "ल्यूटियल")}
                        </p>
                  ...
                  <motion.div
                    ...
                    className="absolute top-0 left-0 sm:-left-4 bg-card lift-strong rounded-2xl p-3 max-w-[180px]"
                  >
                    <div className="flex items-center gap-2 mb-1.5">
                      ...
                      <span className="text-[10px] uppercase tracking-wider font-semibold text-primary">AI</span>
                    </div>
                    <p className="text-[11px] leading-snug text-foreground/85">
                      {t(
                        '"You need 36 mg iron today — methi + chana + gur."',
                        '"आज 36 mg लोहा चाहिए — मेथी + चना + गुड़।"',
                      )}
                    </p>
                  </motion.div>

                  {/* Top-right: AI report finding */}
                  <motion.div
                    initial={{ opacity: 0, x: 20, y: -10 }}
                    animate={{ opacity: 1, x: 0, y: 0 }}
                    transition={{ delay: 0.55 }}
                    className="absolute top-4 right-0 sm:-right-4 surface-premium lift-strong rounded-2xl p-3 max-w-[160px]"
                  >
                    <div className="flex items-center gap-2 mb-1">
                      <span className="text-base">🩺</span>
                      <span className="text-[9px] uppercase tracking-wider font-semibold text-primary">
                        {t("Report flag", "रिपोर्ट")}
                      </span>
                    </div>
                  ...
                  <motion.div
                    ...
                    className="absolute bottom-2 left-0 sm:-left-4 bg-card lift-strong rounded-2xl p-3 flex items-center gap-2.5"
                  >
                    <span className="text-2xl">🔥</span>
                    <div>
                      <p className="font-heading text-2xl leading-none">12</p>
                      <p className="text-[9px] uppercase tracking-wider text-muted-foreground mt-0.5">
                        {t("day streak", "स्ट्रीक")}
                      </p>
                    </div>
                  </motion.div>

                  {/* Bottom-right: voice mic */}
                  <motion.div
                    initial={{ opacity: 0, x: 20, y: 10 }}
                    animate={{ opacity: 1, x: 0, y: 0 }}
                    transition={{ delay: 0.85 }}
                    className="absolute bottom-0 right-0 sm:-right-4 bg-card lift-strong rounded-2xl p-3 max-w-[170px]"
                  >
                    <div className="flex items-center gap-2 mb-1">
                      <span className="w-6 h-6 rounded-full bg-primary text-primary-foreground flex items-center justify-center text-xs animate-pulse">
                        🎙
                      </span>
                      <span className="text-[9px] uppercase tracking-wider font-semibold text-primary">
                        {t("Voice", "आवाज़")}
                    ...
                    <p className="text-[11px] italic leading-snug text-foreground/85">
                      &ldquo;{t("Do roti aur dal khaayi", "दो रोटी और दाल खाई")}&rdquo;
                    </p>
                  </motion.div>

                  {/* ICMR badge — diagonal corner */}
                  <motion.div
                    initial={{ opacity: 0, scale: 0.7, rotate: 0 }}
                    animate={{ opacity: 1, scale: 1, rotate: 8 }}
                    transition={{ delay: 1, type: "spring", stiffness: 120 }}
                    className="absolute top-1/2 -right-1 sm:right-12 surface-gold lift rounded-2xl px-3 py-1.5 text-[10px] font-bold uppercase tracking-wider"
                  >
                    ICMR-NIN 2020
                  </motion.div>
                </div>
        ...
        <section className="max-w-4xl mx-auto px-5 sm:px-8 py-12">
          <div className="rounded-3xl bg-card lift p-6 sm:p-10 text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              {t("Care ₹49/mo for unlimited AI + reports. Pro ₹99/mo unlocks everything + partner access.", "Care ₹49/महीना — अनलिमिटेड AI। Pro ₹99/महीना — सब कुछ।")}
            </p>
            <Link
              href="/pricing"
